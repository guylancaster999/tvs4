               ...
               <?php  print top_bit('Homepage');?>
                <div class="row">
                      <div class="col-sm-9 block">
                       <a href="#" title="Children with certificates"><img src="img/origins.jpg" class="img-responsive img-rounded" alt="Children with certificates"></a>
...
<br/>
					  ...
					  <div class="col-sm-3 block">
						...
						<br/>
						<span class="glyphicon glyphicon-play"></span>&nbsp;Latest study camp a success! Read about it  <a href="activities_studycamps.php#2015" >here</a>.
						<br/>
						<br/>
						<span class="glyphicon glyphicon-play"></span> &nbsp;Click <a href="partnerships.php" title="School Links">here</a> for new School links material.
						</div>
					</div>                  
            </div>
        </div>
