       ...
       <div id="sidebar-wrapper">
         ...
         <div id="page-content-wrapper">
                ...
                <div class="row">
                      <div class="col-sm-9 col-lg-9 col-9 block">
                       ...
                       <h3>Welcome to TVS</h3>
							...
							<li>We provide <a href="activities_it.php" title="IT teaching">IT teaching</a> to over 200 children in 9 primary and 3 secondary schools.<br/>
							<br/>
							</li>
            ...
            <div class='xlatestnews'>Latest News</div>
						  <br/>
              <img align="right" src="img/ncerazantsi_140.jpg"  width="60px"  class="img-rounded"/>
							...
							<br/>
							<br/>
							<img align="right" src="img/growingup.jpg" width="60px" alt="Growing up in a Xhosa Village" class="img-rounded"> 
							<span class="glyphicon glyphicon-play"></span> &nbsp;
							<i>Growing up in Tyume Valley</i> &ndash; new book available
							<br/>
              Click <a href="fundraising.php#book" title="Growing up in Tyume Valley">here</a>.
							<br clear="all"/>
						  <br clear="all"/>
              <img align="right" src="img/202020.jpg" alt="202020" width="60px" />
					    <span class="glyphicon glyphicon-play"></span>&nbsp;
							Can you walk for TVS? New fundraising challenge 2016!
							<br/>
              Click <a href="fundraising.php#walk" title="Fundraising Walk">here</a>.
						  <br clear="all"/>
						  <br clear="all"/>
              <img src="img/report2014button.jpg" width="60px" alt="TVS Annual Report 2014-15"  align="right"  class="img-rounded"/>
						...
						<br clear="all"/>
						<br clear="all"/><img src="img/sc015_140.jpg" align="right" width="60px" class="img-rounded"/>
