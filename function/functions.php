...
function hdr($t)
{
    ...
    <meta name="keywords" content="South, Africa, Education, Tyume, Tyhume,Schools, Valley, Eastern, Cape, TVS, RSA, Volunteering,Teaching,'.$t.'"/>
...
function top_bit($t)
 ...
 function menu($button="Homepage")
 {
    $ret='<div class="sidebar-nav">
           ...
           <br/>';
    $ret.='<div class="newbutton" id="homepage"><a href="index.php" title="Tyume Valley Schools  Home page">Home Page</a></div>
	 ...
	 $ret.='<div class="newbutton" id="committee"><a href="committee.php" title="Tyume Valley Schools  Committee">About us</a></div>';
    
	$ret.='<div class="newbutton" id="activities"><a href="activities.php" title="Tyume Valley Schools Activities">Activities</a></div> ';
	...
	$ret.='<div class="newbutton" id="partnerships"><a href="partnerships.php" title="Tyume Valley - School Links and Partnerships">School Links</a></div>';
...
//	if ($button=="Volunteering")$ret.='<div id="volunteering_button"><div class="redbutton" ><a href="volunteer2016.php" title="Tyume Valley Schools - volunteer in 2016">Volunteer 2016</a></div>		 </div>';
	
	 $ret.='<div class="newbutton" id="fundraising"><a href="fundraising.php" title="Tyume Valley  Fundraising">Fundraising</a></div>';
	 if ($button=='Fundraising')
	 {
		  $ret.=' <div class="redbutton"><a href="books.php">Books</a></div>
