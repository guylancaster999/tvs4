...
<!doctype html>
<html lang="en">
<?php print hdr(" School Links - Settle Kwezana");?>
<body>
    <div id="wrapper">
  ...
  <!-- Page Content -->
        <div id="page-content-wrapper">
            <div class="container-fluid">
               <?php print top_bit(" School Links - Settle Kwezana");?>
                ...
                <div class="row">
					  ...
					  <div class="col-sm-3">
					  <img src="img/kwezana_230.jpg" alt="Kwezana"  class="img-responsive  block  img-rounded"/>
					  <a href="https://settlekwezana.wordpress.com/" title="Kwezana school, Tyume Valley , Western Cape, South Africa"><img src="img/kwezana1.jpg" alt="Kwezana"  class="img-responsive  block  img-rounded"/></a>
                  	<a href="http://www.settle-pri.n-yorks.sch.uk/" title="Settle Church of England Primary School"><img src="img/settle1.jpg" alt="Settle Church of England Primary School"  class="img-responsive img-rounded  block"/></a>
				  	 <a  href="doc/Kwezana_newsletter_03.pdf" title="Friends of Kwezana Primary - Newsletter 3"><img src="img/fkp2.jpg" class="img-responsive img-rounded block" alt="Friends of Kwezana Primary"></a>
				  </div>
					</div>
 	<?php print foot();?> 	
				</div>
